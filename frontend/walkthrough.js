...
const homepageSteps = [
  {
    ...
    content:
      "Pactory helps creators and sponsors create transparent payment agreements. Let's take a quick tour!",
    element: null,
    position: "center",
  ...
  },
  {
    ...
    content:
      "Here you can see your connected wallet address and balances. Connect your wallet to get started!",
    element: ".card",
    position: "bottom",
  },
  {
    ...
    content:
      "Switch between Sponsor and Creator views. This determines which pacts you see and how you interact with them.",
    element: ".view-toggle",
    position: "bottom",
  },
  {
  ...
  },
  {
    ...
    title: "Main Actions",
    content:
      "Connect your wallet to get started, then view your pacts or create new ones. All actions require a connected wallet.",
  ...
  },
  {
    ...
    content:
      "You now know the basics of Pactory. Start by connecting your wallet, then explore creating or viewing pacts. Happy pact-making! 🎉",
    element: null,
    position: "center",
...
const dashboardSteps = [
  {
    ...
    content:
      "This is where you manage all your pacts. Let's explore the key features!",
    element: null,
    position: "center",
    showStartButton: true,
  },
  {
    ...
    title: "Switch Views",
    content:
      "Toggle between Sponsor and Creator views to see different pact categories and actions available to you.",
    element: ".view-toggle",
    position: "bottom",
  },
  {
...
const pactorySteps = [
  {
    ...
    content:
      "This is where you create a new pact. Let's walk through the process!",
    element: null,
    position: "center",
    showStartButton: true,
  },
  {
    ...
    content:
      "Select whether you're creating this pact as a Sponsor or Creator. This determines your responsibilities.",
    element: ".role-toggle",
    position: "bottom",
  },
  {
    ...
    title: "Pact Name",
    content:
      "Give your pact a descriptive name. This helps both parties identify the agreement.",
    element: "#pactName",
    position: "bottom",
  },
  {
  ...
  },
  {
    ...
    content:
      "This graph shows your total payout structure combining both payment types. Adjust milestones and rewards above to see how the payout curve changes in real-time.",
    element: "#payoutGraph",
    position: "right",
  },
  {
    ...
    content:
      'Fill in all the details and click "Send for Review" when ready. The other party will be able to review and negotiate.',
    element: null,
    position: "center",
    showFinishButton: true,
  },
...
const pactViewSteps = [
  ...
  },
  {
    ...
    content:
      "Here you can see the pact name, status, parties involved, duration, and payment structure. Review all details carefully.",
    element: "#content",
    position: "right",
  },
  {
    ...
    content:
      'If your pact is active, you\'ll see real-time stats here: video views, earned amounts, and time remaining. Click "Refresh Views" to update the latest numbers.',
    element: "#activePanel",
    position: "right",
    conditional: () => {
  ...
  },
  {
    ...
    title: "Video Link",
    content:
      "The creator can input the video link here once the pact is created. This link is used to track views and calculate earnings from TikTok, Instagram, or YouTube Shorts.",
    element: "#content",
    position: "right",
  },
  {
...
function createTooltip() {
  ...
  tooltip.className = "walkthrough-tooltip wt-hidden"; // ✅ start hidden

  // park it off-screen too (belt + suspenders)
...
function positionHighlight(element) {
  ...
  if (element) {
    const originalZIndex =
      element.style.zIndex || computedStyle.zIndex || "auto";
...
function positionTooltip(step, element) {
  ...
  // ✅ prevent any animated movement from previous position
  tooltip.classList.add("wt-positioning");
  tooltip.classList.add("wt-hidden");
  ...
  if (step.showStartButton) {
    ...
    tooltipHTML += `
      ...
      <button class="${isLastStep ? "btn-finish" : "btn-next"}"
              onclick="${
                isLastStep
  ...
  // Reset classes without nuking our positioning flags
  ...
  tooltip.classList.add("walkthrough-tooltip");

  // Park it so it can't be seen while measuring
  tooltip.style.top = "-9999px";
  tooltip.style.left = "-9999px";
  tooltip.style.transform = "translate(0,0)";
  ...
  if (rect.width === 0 || rect.height === 0) {
    setTimeout(() => positionTooltip(step, element), 50);
    return;
  }
    ...
    if (step.element.includes("innerText")) {
      ...
      if (match) {
        ...
        element = buttons.find(
          (btn) => btn.innerText && btn.innerText.includes(searchText)
        );
      } else {
  ...
  scrollHandler = (e) => {
    ...
    if (
      ...
      (tooltip.contains(target) ||
        target === tooltip ||
        target.closest(".walkthrough-tooltip"))
    ) {
...
export function finishWalkthrough() {
  ...
  const path = window.location.pathname;
  const pageKey = path.includes("pacts-dashboard")
    ? "dashboard"
    : path.includes("pactory")
    ? "pactory"
    : "homepage";
